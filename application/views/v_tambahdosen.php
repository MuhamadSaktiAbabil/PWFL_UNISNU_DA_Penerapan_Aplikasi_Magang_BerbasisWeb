  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<form action="<?php echo base_url('c_dosen/tambahdatadosen'); ?>" method="POST">
			<div class="modal-body">
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama mahasiswa</label>
                        <div class="col-xs-8">
                            <input name="nama_dosen" class="form-control" maxlength="20" type="text" placeholder="Nama Dosen" required >
                        </div>
                    </div>
