...
<div class="wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><i class="fa fa-fw fa-check"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">Terdaftar</span>
              <span class="info-box-number"><?php echo $terdaftar;?></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo ($sum-$terdaftar);?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Mahasiswa TIF</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Dosen TIF</span>
              <span class="info-box-number"><?php echo $sumdosen;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <section class="col-lg-7 connectedSortable">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Rekapitulasi Praktek Kerja Nyata</h3>
          ...
          <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Lihat Dosen</h3>
  ...
  <footer class="main-footer">
    <div class="text-center">
      <strong>Copyright © 2019 <a href="unisnu.ac.id">UNISNU</a>.</strong> All rights
    reserved.
  </div>
...
<script>
  $(function () {
    ...
    var bar = new Morris.Bar({
      ...
      resize: true,
      data: [
        {y: '2019', a: <?php echo $terdaftar;?>, b: <?php echo ($sum-$terdaftar);?>},
        {y: '2020', a: <?php echo $sum2;?>, b: <?php echo $belum2;?>},
        {y: '2021', a: <?php echo $sum3;?>, b: <?php echo $belum3;?>},
        {y: '2022', a: <?php echo $sum4;?>, b: <?php echo $belum4;?>},
        {y: '2023', a: <?php echo $sum5;?>, b: <?php echo $belum5;?>},
        
      ],
      barColors: ['#00a65a', '#f56954'],
      xkey: 'y',
      ykeys: ['a', 'b'],
      labels: ['jumlah Mahasiswa', 'jumlah ubah nomor'],
      hideHover: 'auto'
    });
  });
</script>
